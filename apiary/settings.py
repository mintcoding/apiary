...
INSTALLED_APPS += [
    #"webtemplate_dbca",
    "apiary",
    "apiary.components.proposal_apiary",
    "rest_framework",
...
TEMPLATES[0]["DIRS"].append(
    os.path.join(BASE_DIR, "apiary", "components", "emails", "templates")
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "apiary.context_processors.apiary_url"
)
...
STATICFILES_DIRS.extend([
    os.path.join(os.path.join(BASE_DIR, "apiary", "static")),
    ])
...
# Department details
SYSTEM_NAME = env("SYSTEM_NAME", "Licensing Template")
...
CRON_CLASSES = [
    "apiary.cron.OracleIntegrationCronJob",
]
