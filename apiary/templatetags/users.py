...
from apiary import helpers as apiary_helpers
...
def is_apiary_admin(context):
    ...
    return apiary_helpers.is_apiary_admin(request)
...
def is_internal(context):
    ...
    request = context["request"]
    return apiary_helpers.is_internal(request)
...
def is_model_backend(context):
    ...
    request = context["request"]
    return apiary_helpers.is_model_backend(request)
